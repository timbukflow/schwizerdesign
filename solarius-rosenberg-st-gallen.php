...
<head>
    ...
    <title>Solarius Rosenberg St.Gallen</title>
    
</head>
<body>
    <header class="projectHeader">
        <div class="projectTitel">
            <h1>Solarius Rosenberg</h1>
        </div>
...
Bautafel
                <ul>
                    <li class="projektLink">Link</li>
                    <li>
                        <a href="https://www.falkenstein.ag/" target="_blank">www.falkenstein.ag</a>
                    </li>
                </ul>
            </h2>
            <h3>
                <span>
                    Advokatur und Treuhand am Falkenstein - Jemand musste Josef K. verleumdet haben, denn ohne dass er etwas Böses getan hatte, wurde er eines Morgens verhaftet. Wie ein Hund sagte er, es war, als sollte die Scham ihn uberleben. Als Gregor Samsa eines Morgens aus unruhigen Traumen erwachte, fand er sich in seinem Bett zu einem ungeheueren Ungeziefer verwandelt. 
                </span>
                <span>    
                    Und es war ihnen wie eine Bestatigung ihrer neuen Traume und guten Absichten, als am Ziele ihrer Fahrt die Tochter als erste sich erhob und ihren jungen Körper dehnte. Es ist ein eigentumlicher Apparat, sagte der Offizier zu dem Forschungsreisenden und uberblickte mit einem gewissermaßen bewundernden Blick den ihm doch wohlbekannten Apparat. Sie hatten noch ins Boot springen können, aber der Reisende hob ein schweres, geknotetes Tau vom Boden, drohte ihnen damit und hielt sie dadurch von dem Sprunge ab. 
                </span> 
                <span>
                    In den letzten Jahrzehnten ist das Interesse an Hungerkunstlern sehr zuruckgegangen. Aber sie uberwanden sich, umdrangten den Kafig und wollten sich gar nicht fortruhren.Jemand musste Josef K. verleumdet haben, denn ohne dass er etwas Böses getan hatte, wurde er eines Morgens verhaftet. Wie ein Hund. sagte er, es war, als sollte die Scham ihn uberleben.
                </span>
            </h3>
        </div>
    </header>
    ...
    <section class="pGridContainer">
        <article class="pGridItem2">
            <picture>
                <source type="image/webp" srcset="img/advokatur-treuhand-falkenstein-christa-rempfler-musiknoten.webp" >
                <source type="image/jpg" srcset="img/advokatur-treuhand-falkenstein-christa-rempfler-musiknoten.jpg" >
                <img 
                    src="img/advokatur-treuhand-falkenstein-christa-rempfler-musiknoten.jpg" 
                    alt="portrait von christa rempfler advokatur am falkenstein mit braunen haaren und brille musiknoten in der hand im auf grauem hintergrund mit fliegenden musiknoten"
                    loading="lazy"
                >
            </picture>
        </article>
        ...
        <article class="pGridItem3">
            <video preload="none" autoplay muted playsinline loop > 
                <source type="video/mp4" src="video/advokatur-treuhand-falkenstein-logo-animation-linien-domino.mp4" >  
            </video>
        </article>
        <article class="pGridItem1">
            <picture>
